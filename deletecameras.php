...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM cameras WHERE id=%s",
...
mysql_select_db($database_Nodal, $Nodal);
$query_Resultats = sprintf("SELECT * FROM cameras WHERE id = %s", $colname_Resultats);
...
mysql_select_db($database_Nodal, $Nodal);
$query_Recordset4 = sprintf("SELECT * FROM cameras WHERE id = %s", $colname_Recordset4);
